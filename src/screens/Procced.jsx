  ...
  const db  = getFirestore(app)
    ...
    <div className=' bg-black h-screen'>
      <div className=' max-w-7xl mx-auto  bg-red-500 h-screen'>
          <div className=' bg-yellow-500 hidden md:block h-52 md:h-96   w-52 border border-black' />
          <div className=' bg-green-500 block md:hidden h-52 w-52 border border-black' />
