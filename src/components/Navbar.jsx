    ...
    <div className=' bg-[#131921] fixed top-0 w-screen z-50 p-2 flex text-white'>
       <div className="flex mx-4 items-center space-x-6 justify-between w-full">
            ...
            <div className=' font-medium whitespace-nowrap '>
                {user ? <div>
                    <p className=' text-gray-400'>Delivery to {user.displayName}</p>
                <p className=' text-lg leading-3'>Hyderabad 500048</p>
                </div> : 
                <p className=' text-gray-400'>Sign In for delivery</p>}
            </div>
            ...
            {user && <div className=' font-medium whitespace-nowrap '>
                <p className=' text-gray-400'>Hello {user?.displayName}</p>
                <div className=' flex'>
